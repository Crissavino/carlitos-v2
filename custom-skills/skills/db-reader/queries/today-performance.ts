  ...
  return {
    ...
    sql: `
      SELECT
        ...
        SUM(CASE WHEN DATE(i.transacted_at) = CURDATE() THEN 1 ELSE 0 END) as today_count,
        SUM(CASE WHEN DATE(i.transacted_at) = CURDATE() - INTERVAL 1 DAY THEN 1 ELSE 0 END) as yesterday_count,
        SUM(CASE WHEN DATE(i.transacted_at) = CURDATE() THEN i.amount / ${CURRENCY_RATE_CASE} ELSE 0 END) as today_amount,
        SUM(CASE WHEN DATE(i.transacted_at) = CURDATE() - INTERVAL 1 DAY THEN i.amount / ${CURRENCY_RATE_CASE} ELSE 0 END) as yesterday_amount
 ...
 * Uses invoice_type_id = 3 (refunds) linked to rebill subscriptions
 */
